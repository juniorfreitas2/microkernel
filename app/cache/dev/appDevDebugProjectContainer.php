...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04d' => 'get1445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04dService',
            '2_445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04d' => 'get2445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04dService',
        ...
        $this->privates = array(
            '1_445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04d' => true,
            '2_445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04d' => true,
    ...
    protected function getCacheWarmerService()
    {
        ...
        })), $c, array()), 4 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this, new \Symfony\Bundle\TwigBundle\TemplateIterator($a, $this->targetDirs[2], array()))));
    }
    ...
    {
        $a = ${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'};

        $b = new \Symfony\Component\Cache\DataCollector\CacheDataCollector();
        $b->addInstance('cache.app', ${($_ = isset($this->services['cache.app']) ? $this->services['cache.app'] : $this->get('cache.app')) && false ?: '_'});
        $b->addInstance('cache.system', ${($_ = isset($this->services['cache.system']) ? $this->services['cache.system'] : $this->get('cache.system')) && false ?: '_'});
        $b->addInstance('cache.validator', new \Symfony\Component\Cache\Adapter\TraceableAdapter(${($_ = isset($this->services['cache.validator.recorder_inner']) ? $this->services['cache.validator.recorder_inner'] : $this->getCache_Validator_RecorderInnerService()) && false ?: '_'}));
        $b->addInstance('cache.serializer', new \Symfony\Component\Cache\Adapter\TraceableAdapter(${($_ = isset($this->services['cache.serializer.recorder_inner']) ? $this->services['cache.serializer.recorder_inner'] : $this->getCache_Serializer_RecorderInnerService()) && false ?: '_'}));
        $b->addInstance('cache.annotations', ${($_ = isset($this->services['cache.annotations']) ? $this->services['cache.annotations'] : $this->getCache_AnnotationsService()) && false ?: '_'});
        ...
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\TimeDataCollector($a, ${($_ = isset($this->services['debug.stopwatch']) ? $this->services['debug.stopwatch'] : $this->get('debug.stopwatch', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'}));
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\MemoryDataCollector());
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\AjaxDataCollector());
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\ExceptionDataCollector());
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\LoggerDataCollector(NULL, (__DIR__.'/appDevDebugProjectContainer')));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('My_Secret');
    }
    ...
    /**
     * Gets the private '1_445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04d' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04dService()
    {
        return $this->services['1_445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04d'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04d' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04dService()
    {
        return $this->services['2_445435e6562279fa39d002cc9e118a59f6d445721feb5152ee202f4c2d8ea04d'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        return $this->services['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vCIW0cSI9S', 0, 'O8HVAs0OZMQiDUoCU346Se', (__DIR__.'/pools'), NULL);
    }
    ...
    {
        return $this->services['cache.app.recorder_inner'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('oZMmW5K66I', 0, (__DIR__.'/pools'));
    }
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FcaWjjNK9m', 0, 'O8HVAs0OZMQiDUoCU346Se', (__DIR__.'/pools'), NULL);
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4vdCx3xeXT', 0, 'O8HVAs0OZMQiDUoCU346Se', (__DIR__.'/pools'), NULL);
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BAIzMDneOA', 0, 'O8HVAs0OZMQiDUoCU346Se', (__DIR__.'/pools'), NULL);
    }
