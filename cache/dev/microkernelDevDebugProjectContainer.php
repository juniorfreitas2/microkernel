...
/**
 * microkernelDevDebugProjectContainer.
 *
 ...
 */
class microkernelDevDebugProjectContainer extends Container
{
    private $parameters;
    ...
    {
        return $this->services['cache.app'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('QyGdRm+yAU', 0, (__DIR__.'/pools'));
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uzCByrdi-S', 0, 'gu0mGDE+31MQo3UL3lnlsw', (__DIR__.'/pools'), NULL);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Secret_KEY');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DaV8dNaLM3', 0, 'gu0mGDE+31MQo3UL3lnlsw', (__DIR__.'/pools'), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'microkernel',
            'kernel.cache_dir' => __DIR__,
            'kernel.bundles' => array(
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'microkernelDevDebugProjectContainer',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'Secret_KEY',
            ...
            'debug.container.dump' => (__DIR__.'/microkernelDevDebugProjectContainer.xml'),
            ...
            'router.options.matcher.cache_class' => 'microkernelDevDebugProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'microkernelDevDebugProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => 'kernel:loadRoutes',
            'router.cache_class_prefix' => 'microkernelDevDebugProjectContainer',
